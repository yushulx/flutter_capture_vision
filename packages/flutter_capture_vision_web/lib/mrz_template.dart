// The MRZ capture template from the reference web sample
// (yushulx/javascript-barcode-qr-code-scanner, examples/barcode_mrz_document).
// The web engine ships no built-in MRZ preset, so `initialize` imports this
// document lazily and `capture` switches between it and the factory presets.
const String mrzTemplateJson = r'''
{
